        ...
        <div class="p-4 lg:p-6 bg-white rounded-2xl">
            ...
            <ul class="space-y-2 text-sm">
                @if($data)
                    ...
                    @endif
                    @if($data->voucher_amount)
                        <li class="flex items-center justify-between">
                            <p class="font-semibold">کد تخفیف</p>
                            <div class="flex items-center gap-1 whitespace-nowrap">
                                <p class="font-semibold">{{number_format($data->voucher_amount)}}</p>
                                <p class="text-sm">تومان</p>
                            </div>
                        </li>
                    @endif
        ...
        <div class="p-4 lg:p-6 bg-white rounded-2xl">
            @if($isSuccessful &&
                ...
                <div class="bg-gray-50 text-primary border border-primary rounded-2xl text-center" wire:ignore>
                    ...
                    <p class="px-3 py-2 font-medium border-t border-primary text-2xl" data-countdown="{{$data->delivery_time}}"></p>
                </div>
            @endif
            ...
            @if($isSuccessful && $data->partner_id == 0)

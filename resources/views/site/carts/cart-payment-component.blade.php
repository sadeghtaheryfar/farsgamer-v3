            ...
            <div class="bg-gray-50 rounded-xl mt-2 text-sm">
                ...
                @if($useVoucher)
                    <div class="flex items-center justify-between p-2">
                        <p>کد تخفیف</p>
                        <div class="flex items-center gap-1">
                            <p class="font-semibold">{{number_format($voucherAmountShow)}}</p>
                            <p>تومان</p>
                        </div>
                    </div>
                @endif
                @if($useWallet)
                    <div class="flex items-center justify-between p-2">
                        <p>کیف پول</p>
                        <div class="flex items-center gap-1">
                            <p class="font-semibold">{{number_format($walletAmountShow)}}</p>
                            <p>تومان</p>
                        </div>
                    </div>
                @endif
                <div class="flex items-center justify-between p-2 border-t border-gray-200">
                    <p>جمع کل</p>
                    <div class="flex items-center gap-1">
                        <p class="font-semibold">{{number_format(Cart::total($walletAmountShow, $voucherAmountShow))}}</p>
                        <p>تومان</p>
                    </div>
                </div>
            </div>

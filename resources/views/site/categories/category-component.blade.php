                    ...
                    <div class="col-12">
                        ...
                        <div class="window-tabs">
                            <div class="tab-control"  wire:ignore>
                                <ul>
								@if(!empty($windows->id))
                                    <li data-id="window"  class="{{ !empty($active_slide) ? 'active' : '' }}">ویترین</li>
								@endif	
                                    <li data-id="skin" class="{{ empty($windows->id) ? 'active' : '' }} {{ !empty($active_slide2) ? 'active' : '' }}" >محصولات</li>
                                    <li></li>
                                </ul>
                            </div>
                            <div class="tabs">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-0">
                                                <div class="window-product-dtails">
                                                    ...
                                                    <div class="col-12">
                                                        <a href="{{route('products.show',['slug' => $mainProduct->slug ])}}" class="btn btn-primary">خرید</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
								...
								@endif	
                                <div  class="slide skin {{ empty($windows->id) ? 'active_slide' : '' }} {{$active_slide2}}" id="skin"  wire:ignore.self>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="filters mt-1">
                                                            <div class=" form-switch d-flex align-items-center py-2 px-1">
																...
																<input type="checkbox" {{ $level == 1 ? 'checked' : '' }}  id="switchD" value="1">
                                                        ...
                                                        <div class="advanced-search p-0">
                                                            ...
                                                            <div class="bg-white px-3 py-2 d-flex align-items-center justify-content-between resp_button_height">
                                                                ...
                                                                <div class=" form-switch d-flex align-items-center p-1">
																	...
																	<input type="checkbox" {{ $level == 1 ? 'checked' : '' }}  id="switch" value="1">
                                                                ...
                                                                <div class="sidenav" wire:ignore>
																			...
																			<div class="d-flex align-items-center py-1">
																				<div class="price-range res p-0">
																					...
																					<div class="col-12">
																							...
																							<input type="hidden" value="{{$max}}" id="max-range">
																					</div>
																					...
																					<div class="text-center">
																						...
																						<small>تا</small>
																						<input value="{{number_format($range)}}" class="py-1 px-2" id="range-show" disabled type="text">
																						<small>تومان</small>
																					</div>
																				</div>
																			</div>
																	...
																	<div class="col-12 form-group py-1 px-2 filter_groups mb-3">
																		...
																		<div class="d-flex align-items-center py-1">
																			...
																			@foreach($sub_categories as $key => $item)
																			<div class="d-flex align-items-center py-1">
																			<input class="form-check-input" value="{{$item['id']}}" name="sub_categorym" type="radio" id="sub_category{{$item['id']}}m" wire:model="sub_category">
																				<label class="mb-0 mx-2 form-check-label" for="sub_category{{$item['id']}}m">{{$item['title']}}</label>
																					</div>
																			@endforeach
																		</div>
																	</div>
																	...
																	@foreach($groups as $key => $item)
																		<div class="col-12 form-group py-2 filter_groups mb-3">
																			...
																			<div class="dropdown-container mt-2">
																				@foreach($item['filters'] as $key => $filter)
																					<div class="d-flex align-items-center py-1">
																						<input type="checkbox" class="big-checkbox form-check-input" id="fliter{{$filter['id']}}m" wire:model="filter.{{$filter['id']}}">
																						<label class="mb-0 mx-2 form-check-label" for="fliter{{$filter['id']}}m">{{$filter['title']}}</label>
																					</div>
																				@endforeach
																			</div>
																		</div>

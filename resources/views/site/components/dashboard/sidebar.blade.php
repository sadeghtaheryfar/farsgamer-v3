<section id="right-dashboard">
    <a href="{{ route('home') }}" class="hover-menu-dashboard box-exit-dashboard flex-box">
        ...
        <div class="box-item-menu-dashboard">
            <ul>
                ...
                <a href="{{ route('dashboard.profile') }}">
                    <li
                        class="flex-box flex-right {{ \Illuminate\Support\Facades\Route::currentRouteName() == 'dashboard.profile' ? ' item-menu-dashboard-active' : '' }}">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path

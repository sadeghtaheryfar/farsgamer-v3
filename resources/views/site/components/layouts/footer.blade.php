        ...
        <div class="text-center mt-8 xl:mt-0 xl:mb-14 xl:w-6/12">
            ...
            <div class="flex gap-4 justify-center">
                <a class="w-12 h-12 2xs:w-16 2xs:h-16 rounded-2xl flex items-center justify-center bg-primary bg-opacity-10 hover:bg-opacity-100 focus:bg-opacity-100 transition-colors duration-200 group"
                   href="{{$twitter['url'] ?? ''}}">
                    <i class="icon-twitter text-primary group-hover:text-white group-focus:text-white leading-none text-xl 2xs:text-2xl"></i>
                </a>
                <a class="w-12 h-12 2xs:w-16 2xs:h-16 rounded-2xl flex items-center justify-center bg-primary bg-opacity-10 hover:bg-opacity-100 focus:bg-opacity-100 transition-colors duration-200 group"
                   href="{{$instagram['url'] ?? ''}}">
                    <i class="icon-instagram text-primary group-hover:text-white group-focus:text-white leading-none text-xl 2xs:text-2xl"></i>
                </a>
                <a class="w-12 h-12 2xs:w-16 2xs:h-16 rounded-2xl flex items-center justify-center bg-primary bg-opacity-10 hover:bg-opacity-100 focus:bg-opacity-100 transition-colors duration-200 group"
                   href="{{$telegram['url'] ?? ''}}">
                    <i class="icon-telegram-plane text-primary group-hover:text-white group-focus:text-white leading-none text-xl 2xs:text-2xl"></i>
                </a>
                <a class="discord-link w-12 h-12 2xs:w-16 2xs:h-16 rounded-2xl flex items-center justify-center bg-primary bg-opacity-10 hover:bg-opacity-100 focus:bg-opacity-100 transition-colors duration-200 group"
                   href="https://discord.gg/2kYFXHh3">
                    <i class="icon_discord text-primary group-hover:text-white group-focus:text-white leading-none text-xl 2xs:text-2xl"></i>
                </a>
            </div>
        </div>
        <div class="xl:w-3/12">
            <div class="mt-8 grid justify-center xl:justify-end xl:mt-0">
               ...
               <div class="flex new_mt">
                     <div class="trust_symbol">
						<a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=219672&amp;Code=yECDeYH06VHLxw3VZRBT"><img referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=219672&amp;Code=yECDeYH06VHLxw3VZRBT" alt="" style="cursor:pointer" id="yECDeYH06VHLxw3VZRBT"></a>

					</div> 
					
					
                    <div class="trust_symbol">
						 <img id='nbqergvjoeuksizpjzpesizp' style ='cursor:pointer' onclick='window.open("https://logo.samandehi.ir/Verify.aspx?id=238979&p=uiwkxlaomcsipfvljyoepfvl", "Popup","toolbar=no, scrollbars=no, location=no, statusbar=no, menubar=no, resizable=0, width=450, height=630, top=30")' alt ='logo-samandehi' src='https://logo.samandehi.ir/logo.aspx?id=238979&p=odrfqftiaqgwbsiyyndtbsiy' /> 
					</div>
					<div class="trust_symbol">
						<a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=470500&Code=syam0CsLG2cKfPBsvaHOVgrdYK7dIUaw'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?	id=470500&Code=syam0CsLG2cKfPBsvaHOVgrdYK7dIUaw' alt='' style='cursor:pointer' Code='syam0CsLG2cKfPBsvaHOVgrdYK7dIUaw'></a>
					</div>
			...
			<div class="flex new_mt">
					...
					<div class="trust_symbol">
						<a class="" referrerpolicy="origin" target="_blank">
							<img referrerpolicy="origin" src="{{asset('/site/images/Shetab-logo-LimooGraphic.png')}}" alt="" style="cursor:pointer" id="yECDeYH06VHLxw3VZRBT">
						</a>
					</div>
					<!-- <div class="trust_symbol">

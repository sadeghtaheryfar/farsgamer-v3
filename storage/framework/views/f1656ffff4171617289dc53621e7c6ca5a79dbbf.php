    ...
    <div class="xl:col-start-9 xl:col-end-13 2xl:col-start-10 xl:row-span-full">
        <div class="p-4 lg:p-6 bg-white rounded-2xl">
            ...
            <div class="bg-gray-50 rounded-xl mt-2 text-sm">
                ...
                <?php if($useVoucher): ?>
                    <div class="flex items-center justify-between p-2">
                        <p>کد تخفیف</p>
                        <div class="flex items-center gap-1">
                            <p class="font-semibold"><?php echo e(number_format($voucherAmount)); ?></p>
                            <p>تومان</p>
                        </div>
                    </div>
                <?php endif; ?>
                <?php if($useWallet): ?>
                    <div class="flex items-center justify-between p-2">
                        <p>کیف پول</p>
                        <div class="flex items-center gap-1">
                            <p class="font-semibold"><?php echo e(number_format($walletAmount)); ?></p>
                            <p>تومان</p>
                        </div>
                    </div>
                <?php endif; ?>
                <div class="flex items-center justify-between p-2 border-t border-gray-300">
                    <p>جمع کل</p>
                    <div class="flex items-center gap-1">
                        <p class="font-semibold"><?php echo e(number_format(Cart::total($walletAmount, $voucherAmount))); ?></p>
                        <p>تومان</p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative mt-4">
                ...
                <button class="btn btn-primary absolute top-0 bottom-0 left-0 text-sm" wire:click="checkVoucherCode">تخفیف بده</button>
            </div>
            <?php if($useVoucher): ?>
...
unset($__errorArgs, $__bag); ?>
            <button class="btn form-submit btn-primary btn-2xl w-full mt-2" wire:click="payment">ادامه تسویه حساب</button>
        </div>
    </div>
</div>
<?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/site/carts/cart-payment-component.blade.php ENDPATH**/ ?>
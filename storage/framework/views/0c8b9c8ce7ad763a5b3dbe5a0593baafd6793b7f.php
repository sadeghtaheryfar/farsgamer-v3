<section class="mt-8">
    ...
    <div class="grid gap-4 md:grid-cols-7 xl:flex">
        ...
        <?php if($specialDiscountOne): ?>
            <a href="<?php echo e(route('products.show', $specialDiscountOne->slug)); ?>" class="relative flex mb-4 md:col-span-3 md:order-2 md:mb-0 xl:max-w-md">
                    ...
                    <a href="<?php echo e(route('products.show', $specialDiscountTwo->slug)); ?>"
                       class="w-full grid gap-4 2xs:row-span-full bg-white p-2 rounded-2xl 2xs:grid-cols-2 2xs:items-center 2xs:justify-between">
                        ...
                        <div class="py-2 text-center 2xs:col-start-1 2xs:col-end-2">
                            ...
                            <h3 class="font-semibold my-4 md:text-xl 2xl:text-2xl px-2 flex justify-center overflow-hidden"><?php echo e($specialDiscountTwo->title); ?></h3>
                            ...
                            <div class="h-14 inline-block mx-auto">
                                <div class="bg-gray-100 py-1 px-6 rounded-xl">
                                    <?php if($specialDiscountTwo->price_with_discount == 0): ?>
                                        <p class="text-center inline-block gap-0.5 <?php echo e($specialDiscountTwo->is_active_discount ? '' : 'py-2'); ?>">
                                            <span class="text-sm">قیمت متغیر</span>
                                        </p>
                                    <?php else: ?>
                                        <p class="text-center inline-block gap-0.5 <?php echo e($specialDiscountTwo->is_active_discount ? '' : 'py-2'); ?>">
                                            <span class="font-semibold"><?php echo e(number_format($specialDiscountTwo->price_with_discount)); ?></span>
                                    ...
                                    <?php if($specialDiscountTwo->is_active_discount): ?>
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <span class="font-semibold line-through text-gray2-700"><?php echo e(number_format($specialDiscountTwo->price)); ?></span>
                                            
                                            <div class="bg-red text-white rounded-full py-0.5 px-2 text-xs"><?php echo e($specialDiscountTwo->discount_percentage); ?>%</div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 flex w-full justify-center items-center gap-1">
                                <div data-countdown="<?php echo e($specialDiscountTwo->discount_expires_at ?? '3030-03-03'); ?>"></div>
                ...
                <div>
                    <a href="<?php echo e(route('products.show', $specialDiscountThree->slug)); ?>"
                       class="w-full grid gap-4 2xs:row-span-full bg-white p-2 rounded-2xl 2xs:grid-cols-2 2xs:items-center 2xs:justify-between">
                        ...
                        <div class="py-2 text-center 2xs:col-start-1 2xs:col-end-2">
                            <span class="inline-block bg-gray2-100 rounded-full py-2 px-3 font-medium text-red text-xs">تخفیف ویژه</span>
                            <h3 class="font-semibold my-4 md:text-xl 2xl:text-2xl px-2 flex justify-center overflow-hidden"><?php echo e($specialDiscountThree->title); ?></h3>

                            <div class="h-14 inline-block mx-auto">
                                <div class="bg-gray-100 py-1 px-6 rounded-xl">

                                    <?php if($specialDiscountThree->price_with_discount == 0): ?>
                                        <p class="text-center inline-block gap-0.5 <?php echo e($specialDiscountThree->is_active_discount ? '' : 'py-2'); ?>">
                                            <span class="text-sm">قیمت متغیر</span>
                                        </p>
                                    <?php else: ?>
                                        <p class="text-center inline-block gap-0.5 <?php echo e($specialDiscountThree->is_active_discount ? '' : 'py-2'); ?>">
                                            <span class="font-semibold"><?php echo e(number_format($specialDiscountThree->price_with_discount)); ?></span>
                                            <span class="text-sm">تومان</span>
                                        </p>
                                    <?php endif; ?>
                                    ...
                                    <?php if($specialDiscountThree->is_active_discount): ?>
                                        <div class="flex items-center justify-center gap-2">
                                            ...
                                            <span class="font-semibold line-through text-gray2-700"><?php echo e(number_format($specialDiscountThree->price)); ?></span>
                                            
                                            <div class="bg-red text-white rounded-full py-0.5 px-2 text-xs"><?php echo e($specialDiscountThree->discount_percentage); ?>%</div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="mt-4 flex w-full justify-center items-center gap-1">
                                <div data-countdown="<?php echo e($specialDiscountThree->discount_expires_at ?? '3030-03-03'); ?>"></div>
                                <i class="icon-clock"></i>
                            </div>
                        </div>
                    </a>
...
</section><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/homes/special-discount.blade.php ENDPATH**/ ?>
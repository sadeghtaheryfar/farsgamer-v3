                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="category">
                                                    <div class="d-flex align-items-center justify-content-start"
                                                        ...
                                                        <div class="px-2"><img src="<?php echo e(asset($item['icon'])); ?>"
                                                                alt=""></div>
                                                        <a href=""
                                                            class="d-none d-lg-block d-xl-block"><?php echo e($item['title']); ?></a>
                                                        <a class="d-block d-lg-none d-xl-none position-relative"
                                                            style="z-index: -1;"><?php echo e($item['title']); ?></a>
                                                    </div>
                                                    <div class="d-block d-lg-none d-xl-none">
                                                        <div class="sub-categories">
                                                            <div class="sub_category"
                                                                data-response-id="<?php echo e($item['id']); ?>">
                                                                <ul>
                                                                    <li>
                                                                        <div class="px-2">
                                                                            <a
                                                                                href="<?php echo e(route('index.categories', $item['slug'])); ?>">همه
                                                                                محصولات این دسته</a>
                                                                            <i
                                                                    ...
                                                                    <?php $__currentLoopData = $item['children_recursive']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <li>
                                                                            <div class="px-2">
                                                                                <a
                                                                                    href="<?php echo e(route('index.categories', $item2['slug'])); ?>"><?php echo e($item2['title']); ?></a>
                                                                                <i
                                                                                    class="fas fa-chevron-left text-secondary"></i>
                                                                            </div>
                                                                        </li>
                                                    ...
                                                    <ul>
                                                        <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li>
                                                                <div class="px-2">
                                                                    <a
                                                                        href="<?php echo e(route('index.categories', $value['slug'])); ?>"><?php echo e($value['title']); ?></a>
                                                                </div>
                                                            </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                        ...
                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="category">
                                                <div class="d-flex align-items-center justify-content-start"
                                                    ...
                                                    <a href="<?php echo e(route('index.categories', $item['slug'])); ?>"
                                                        class="d-none d-lg-block d-xl-block"><?php echo e($item['title']); ?></a>
                                                    <a href="<?php echo e(route('index.categories', $item['slug'])); ?>"
...
<?php /**PATH C:\Users\Asian\Documents\GitHub\farsgamer-v3\resources\views/site/components/layouts/sidebar3.blade.php ENDPATH**/ ?>
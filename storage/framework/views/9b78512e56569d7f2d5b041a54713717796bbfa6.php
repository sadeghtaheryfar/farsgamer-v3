                ...
                <div class="swiper-slide">
                    <a class="post-box post-box--slide" href="<?php echo e(route('articles.show', $article->slug)); ?>">
                        ...
                        <div class="post-box__content">
							...
							<h5 class="post-box__cat"><?php echo e(!empty($article->categories->title) ? $article->categories->title : 'بدون دسته بندی'); ?></h5>
...
</section><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/homes/recent-articles.blade.php ENDPATH**/ ?>
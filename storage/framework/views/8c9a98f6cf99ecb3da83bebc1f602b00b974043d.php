                                ...
                                <?php $__currentLoopData = $item['children_recursive']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li>
                                        <a href="<?php echo e(route('index.categories', $item2['slug'])); ?>"
                                            class="item-box-hever-store"><?php echo e($item2['title']); ?></a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
        ...
        <div class="box-menu">
            <ul class="ul-nav-menu">
                ...
                <a href="<?php echo e(route('home')); ?>">
                    <li class="nav-menu-item <?php echo e(request()->routeIs('home') ? 'nav-menu-item-active' : ''); ?>">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <a href="<?php echo e(route('faqs')); ?>">
                    <li class="nav-menu-item <?php echo e(request()->routeIs('faqs') ? 'nav-menu-item-active' : ''); ?>"
                        id="menu3">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
...
<?php /**PATH C:\Users\Asian\Documents\GitHub\farsgamer-v3\resources\views/site/components/layouts/sidebar2.blade.php ENDPATH**/ ?>
    ...
    <?php if($item['type'] == 'text'): ?>
        <?php if(FormBuilder::isVisible($form, $item)): ?>
            <div class="col-span-2 lg:col-span-<?php echo e($item['width']); ?>">
                ...
                <input id="<?php echo e($key); ?>" type="text" name="<?php echo e($item['name']); ?>" class="form-control" placeholder="<?php echo e($item['placeholder']); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($item['type'] == 'textArea'): ?>
        <?php if(FormBuilder::isVisible($form, $item)): ?>
            <div class="col-span-2 lg:col-span-<?php echo e($item['width']); ?>">
                <label for="<?php echo e($key); ?>" class="account-email"><?php echo $item['label']; ?></label>
                <textarea id="<?php echo e($key); ?>" name="<?php echo e($item['name']); ?>" class="form-control h-auto resize-y"
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if($item['type'] == 'select'): ?>
        <?php if(FormBuilder::isVisible($form, $item)): ?>
            <div class="col-span-2 lg:col-span-<?php echo e($item['width']); ?>">
                <label for="<?php echo e($key); ?>" class="account-email"><?php echo $item['label']; ?></label>
                <select id="<?php echo e($key); ?>" name="<?php echo e($item['name']); ?>" class="form-control h-auto resize-y" wire:model="form.<?php echo e($key); ?>.value">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/components/products/partner-form-builder.blade.php ENDPATH**/ ?>
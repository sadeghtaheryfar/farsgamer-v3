<?php if(sizeof($products) > 0): ?>
    <section wire:ignore>
        <div class="flex items-center justify-between mb-4 mt-8 lg:mb-6 lg:mt-10">
            ...
            <a class="flex gap-2 items-center" href="<?php echo e(route('products')); ?>?category=fortnite&sort=latest">
...
<?php endif; ?><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/homes/fortnite.blade.php ENDPATH**/ ?>
<div>
    ...
    <?php echo $__env->make('site.homes.categories', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <section class="grid gap-4 mt-4 sm:grid-cols-2 xl:grid-cols-4">
        <?php $__currentLoopData = \App\Models\Setting::whereIn('name', ['home_small_five', 'home_small_six', 'home_small_seven', 'home_small_eight'])->get()->pluck('value', 'id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Asian\Documents\GitHub\farsgamer-v3\resources\views/site/homes/home.blade.php ENDPATH**/ ?>
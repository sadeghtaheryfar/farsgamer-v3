...
} elseif ($_instance->childHasBeenRendered('ub78L3k')) {
    $componentId = $_instance->getRenderedChildComponentId('ub78L3k');
    $componentTag = $_instance->getRenderedChildComponentTagName('ub78L3k');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ub78L3k');
} else {
    $response = \Livewire\Livewire::mount('site.articles.article-create-comment', ['article' => $article]);
    $html = $response->html();
    $_instance->logRenderedChild('ub78L3k', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/articles/article-component.blade.php ENDPATH**/ ?>
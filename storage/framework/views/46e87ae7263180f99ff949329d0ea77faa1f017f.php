            ...
            <ul class="ul-nav-menu">
                <a href="https://www.farsgamer.com/shop">
                    <li class="nav-menu-item nav-menu-item-store" id="menu1">
                        <div class="box-nav1">
                            <img id="icon-menu17" src="<?php echo e(asset("site-v2/img/game-dark.svg")); ?>" alt=""
                                class="icon-nav-menu hide-item">
                            <img id="icon-menu18" src="<?php echo e(asset("site-v2/img/game.svg")); ?>" alt="" class="icon-nav-menu">
                ...
                <a href="<?php echo e(route('home')); ?>">
                    <li class="nav-menu-item nav-menu-item-active">
                        <img id="icon-menu1" src="<?php echo e(asset("site-v2/img/home-white.svg")); ?>" alt="" class="icon-nav-menu">

                        <img id="icon-menu2" src="<?php echo e(asset("site-v2/img/home-dark.svg")); ?>" alt=""
                            class="icon-nav-menu hide-item">
                ...
                <a href="<?php echo e(route('faqs')); ?>">
                    <li class="nav-menu-item" id="menu3">
                        <img id="icon-menu3" src="<?php echo e(asset("site-v2/img/prudect.svg")); ?>" alt="" class="icon-nav-menu">

                        <img id="icon-menu4" class="hide-item" src="<?php echo e(asset("site-v2/img/box-search-dark.svg")); ?>" alt="">
                ...
                <a href="<?php echo e(route('faq')); ?>">
                    <li class="nav-menu-item" id="menu4">
                        <img id="icon-menu5" src="<?php echo e(asset("site-v2/img/messages.svg")); ?>" alt="" class="icon-nav-menu">

                        <img id="icon-menu6" class="hide-item" src="<?php echo e(asset("site-v2/img/messages-dark.svg")); ?>" alt="">
                ...
                <a href="<?php echo e(route('rules')); ?>">
                    <li class="nav-menu-item" id="menu5">
                        <img id="icon-menu7" src="<?php echo e(asset("site-v2/img/book.svg")); ?>" alt="" class="icon-nav-menu">

                        <img id="icon-menu8" class="hide-item" src="<?php echo e(asset("site-v2/img/book-dark.svg")); ?>" alt="">
                ...
                <a href="<?php echo e(route('why-us')); ?>">
                    <li class="nav-menu-item" id="menu7">
                        <img id="icon-menu9" src="<?php echo e(asset("site-v2/img/book.svg")); ?>" alt="" class="icon-nav-menu">

                        <img id="icon-menu10" class="hide-item" src="<?php echo e(asset("site-v2/img/book-dark.svg")); ?>" alt="">
                ...
                <a href="<?php echo e(route('contact-us')); ?>">
                    <li class="nav-menu-item" id="menu8">
                        <img id="icon-menu11" src="<?php echo e(asset("site-v2/img/sms.svg")); ?>" alt="" class="icon-nav-menu">

                        <img id="icon-menu12" class="hide-item" src="<?php echo e(asset("site-v2/img/sms-dark.svg")); ?>" alt="">
                ...
                <a href="<?php echo e(route('articles')); ?>">
                    <li class="nav-menu-item" id="menu9">
                        <img id="icon-menu13" class="" src="<?php echo e(asset("site-v2/img/note.svg")); ?>" alt="">

                        <img id="icon-menu14" class="hide-item" src="<?php echo e(asset("site-v2/img/note-2-dark.svg")); ?>" alt="">
                ...
                <a href="request.html">
                    <li class="nav-menu-item" id="menu10">
                        ...
                        <img id="icon-menu16" class="hide-item" src="<?php echo e(asset("site-v2/img/Frame-dark.svg")); ?>" alt="">
            ...
            <div id="hover-store-mobile">
                ...
                <div class="message-store-mobile">
                    <div class="item-header-mobile open-box-category">
                        ...
                        <img src="<?php echo e(asset("site-v2/img/Vector.svg")); ?>" class="icon-header-store-mbile icon-category-header-store"
                            alt="">
                    </div>

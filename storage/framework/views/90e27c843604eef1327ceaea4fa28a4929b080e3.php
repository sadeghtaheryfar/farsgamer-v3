            ...
            <div class="comment__content" x-data="{open: false}">
                ...
                <form class="comment__form mt-4" x-show="open" wire:submit.prevent="storeAnswer()">
                    <?php if(auth()->guard()->guest()): ?>
                        <p class="comment__form-content">برای ثبت پاسخ <a href="<?php echo e(route('login')); ?>"><span class="text-primary font-semibold">وارد</span></a> سایت شوید</p>
                    <?php endif; ?>
...
</div><?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/site/products/products-question.blade.php ENDPATH**/ ?>
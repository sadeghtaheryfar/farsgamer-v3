...
<?php if(gettype($image) == 'string'): ?>
    <div class="form-group col-12">
        <?php $__currentLoopData = explode(',', $image); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <img src="<?php echo e(asset($item)); ?>" alt="" width="150px" height="150px" class="mr-1 mb-1"/>
...
</div><?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/components/admin/forms/lfm-standalone.blade.php ENDPATH**/ ?>
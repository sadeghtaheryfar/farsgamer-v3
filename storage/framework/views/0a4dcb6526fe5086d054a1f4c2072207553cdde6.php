<?php $__currentLoopData = $form; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($item['type'] == 'text'): ?>
        <?php if(FormBuilder::isVisible($form, $item)): ?>
            <div>
                <label for="<?php echo e($key); ?>"><?php echo $item['label']; ?></label>

                <input id="<?php echo e($key); ?>" name="<?php echo e($item['name']); ?>" class="input-style-text-product input-hover"
                    type="text" placeholder="<?php echo e($item['placeholder']); ?>"

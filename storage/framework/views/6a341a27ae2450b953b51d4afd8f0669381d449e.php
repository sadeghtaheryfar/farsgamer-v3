...
} elseif ($_instance->childHasBeenRendered('RLCvczu')) {
    $componentId = $_instance->getRenderedChildComponentId('RLCvczu');
    $componentTag = $_instance->getRenderedChildComponentTagName('RLCvczu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RLCvczu');
} else {
    $response = \Livewire\Livewire::mount('site.dashboard.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('RLCvczu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/dashboard/my-orders-component.blade.php ENDPATH**/ ?>
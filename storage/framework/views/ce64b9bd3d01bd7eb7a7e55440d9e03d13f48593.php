                ...
                <ul class="select-box__options-list" @click="open = false" @click.away="open = false">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li value="<?php echo e($item->id); ?>" class="select-box__option"
                            x-on:click="category = '<?php echo e($item->title); ?>';$wire.set('category', '<?php echo e($item->slug); ?>')"><strong><?php echo e($item->title); ?></strong></li>
                        <?php $__currentLoopData = $item->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li value="<?php echo e($subCategory->id); ?>" class="select-box__option"
                                x-on:click="category = '<?php echo e($subCategory->title); ?>';$wire.set('category', '<?php echo e($subCategory->slug); ?>')"><?php echo e($subCategory->title); ?></li>
...
</div><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/products/products-component.blade.php ENDPATH**/ ?>
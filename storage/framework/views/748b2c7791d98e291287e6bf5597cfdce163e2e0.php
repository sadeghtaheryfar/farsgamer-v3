<?php $attributes = $attributes->exceptProps(['id', 'label', 'options', 'help', 'required' => false]); ?>
<?php foreach (array_filter((['id', 'label', 'options', 'help', 'required' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<div class="form-group col-12">
    ...
    <?php endif; ?>
</div><?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/components/admin/forms/dropdown.blade.php ENDPATH**/ ?>
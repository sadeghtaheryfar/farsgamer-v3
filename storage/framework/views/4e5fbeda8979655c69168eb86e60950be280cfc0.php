...
} elseif ($_instance->childHasBeenRendered('ihE5cTR')) {
    $componentId = $_instance->getRenderedChildComponentId('ihE5cTR');
    $componentTag = $_instance->getRenderedChildComponentTagName('ihE5cTR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ihE5cTR');
} else {
    $response = \Livewire\Livewire::mount('site.dashboard.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('ihE5cTR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</div><?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/site/dashboard/my-comments-component.blade.php ENDPATH**/ ?>
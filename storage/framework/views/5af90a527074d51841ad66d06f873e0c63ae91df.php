...
<?php endif; ?>
                    ...
                    <li>
						<a class="nav-menu-item <?php echo e(request()->routeIs('lottery') ? 'nav-menu-item--active' : ''); ?>" href="<?php echo e(route('lottery')); ?>">
...
</sidebar><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/components/layouts/sidebar.blade.php ENDPATH**/ ?>
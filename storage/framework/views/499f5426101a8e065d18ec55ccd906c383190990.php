				...
				<?php if(($start_lottery)): ?>
					<div class="flex items-center justify-between my-lottery-score">
						<div class="flex items-center gap-2">
							...
							<p>شانس قرعه کشی</p>
							<p class="font-bold"><?php echo e($lottery); ?></p>
						</div>
					</div>
				<?php endif; ?>
        ...
        <nav class="mt-4" wire:ignore>
            <ul>
				...
				<?php if( auth()->user()->hasRole('همکار') ): ?>
					<li>
						<a class="nav-menu-item " href="<?php echo e(route('partner.orders')); ?>">
                        <i class="nav-menu-item__icon icon-user"></i>
...
<?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/components/dashboard/sidebar.blade.php ENDPATH**/ ?>
<div class="grid gap-4 xl:grid-cols-12 xl:items-start xl:gap-8">
        ...
        <div class="p-4 lg:p-6 bg-white rounded-2xl">
            ...
            <?php else: ?>
                <div class="bg-pink font-medium flex flex-wrap items-center justify-center gap-y-2 gap-x-8 p-2 rounded-2xl mb-4">
                    ...
                    <button class="btn btn-primary btn-outline btn-xs" wire:click="tryAgain">دوباره تلاش کنید</button>
                </div>
            <?php endif; ?>
    ...
    <div class="xl:col-start-9 xl:col-end-13 2xl:col-start-10 xl:row-span-full">
        ...
        <div class="p-4 lg:p-6 bg-white rounded-2xl">
            <?php if($isSuccessful): ?>
                <div class="bg-gray-50 text-primary border border-primary rounded-2xl text-center">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/site/carts/cart-checkout-component.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('l2160533315-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l2160533315-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2160533315-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2160533315-0');
} else {
    $response = \Livewire\Livewire::mount('site.dashboard.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2160533315-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class=" mx-auto col-12 mt-4">
                ...
                <?php elseif(auth()->user()->auth_status == App\Models\User::USER_REJECT_AUTH): ?>
                    <div class="alert alert-danger">
                        <h4> <strong> نتیجه احراز هویت :</strong> </h4>
                        <small class="mr-1"><?php echo e(auth()->user()->checkedBy->full_name ?? 'سیستم'); ?> :
                            <?php echo e(auth()->user()->auth_result); ?><small>
                    </div>
            ...
            <?php if(auth()->user()->auth_status == App\Models\User::USER_NEED_AUTH ||
                    ...
                    <div class="row  lg:p-3 mx-1">
                        ...
                        <div class="row col-12">
                            <div
                                ...
                                <?php else: ?>
                                    <img class="w-50" src="<?php echo e(asset($auth_image_pattern)); ?>"
                                    ...
                                    <form class="text-center py-5">
                                        <div x-data="{ isUploading: false, progress: 0 }" x-on:livewire-upload-start="isUploading = true"
                                            ...
                                            <input type="file" wire:model="file"
                                                <?php echo e(auth()->user()->auth_status == App\Models\User::UESR_PENDING ? 'disabled' : ''); ?>
                                            ...
                                            <div class="text-center">
                                                <img class="mx-auto" src="<?php echo e(asset('site/svg/upload.svg')); ?>"
                                                    alt="">
                                            </div>
...
<?php /**PATH C:\Users\Asian\Documents\GitHub\farsgamer-v3\resources\views/site/dashboard/profile-component.blade.php ENDPATH**/ ?>
    ...
    <?php else: ?>
        ...
        <div class="xl:col-start-9 xl:col-end-13 2xl:col-start-10 xl:row-span-full">
            <div class="p-4 lg:p-6 bg-white rounded-2xl">
                ...
                <a href="<?php echo e(route('cart.payment')); ?>" class="btn form-submit btn-primary btn-2xl w-full mt-4"
                   wire:loading.attr="disabled">ادامه تسویه حساب</a>
            </div>
        </div>
    <?php endif; ?>
</div>
<?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/carts/cart-component.blade.php ENDPATH**/ ?>
        ...
        <div class="bg-gray-50 rounded-2xl grid gap-4 p-4 sm:flex sm:items-center">
            ...
            <div class="grid gap-4 px-2 sm:h-full sm:content-between lg:py-2 lg:px-0">
                ...
                <ul class="text-gray-500 text-sm">
                    <li>تاریخ: <span><?php echo e(jalaliDate($article->j_created_at, '%d %B %Y')); ?></span></li>
...
} elseif ($_instance->childHasBeenRendered('VOaszXJ')) {
    $componentId = $_instance->getRenderedChildComponentId('VOaszXJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('VOaszXJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VOaszXJ');
} else {
    $response = \Livewire\Livewire::mount('site.articles.article-create-comment', ['article' => $article]);
    $html = $response->html();
    $_instance->logRenderedChild('VOaszXJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                </div>
...
<?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/site/articles/article-component.blade.php ENDPATH**/ ?>
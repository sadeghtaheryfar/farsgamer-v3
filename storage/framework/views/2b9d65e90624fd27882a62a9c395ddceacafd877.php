...
} elseif ($_instance->childHasBeenRendered('MZF333x')) {
    $componentId = $_instance->getRenderedChildComponentId('MZF333x');
    $componentTag = $_instance->getRenderedChildComponentTagName('MZF333x');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MZF333x');
} else {
    $response = \Livewire\Livewire::mount('site.dashboard.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('MZF333x', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="do__item" x-data="{open : false}">
                                ...
                                <div class="do__item-cell do__item-cell__buttons">
                                    <div class="grid gap-1">
                                        <a href="<?php echo e(route('dashboard.orders.show', $item->id + \App\Models\Order::CHANGE_ID)); ?>" class="btn px-8 btn-primary btn-xs btn-outline w-full">نمایش</a>
                                ...
                                <div class="col-start-1 col-end-7 pt-4 -mt-4 border-t border-gray-200" x-bind:class="{ 'collapse': !open }">
                                    <div class="grid gap-4">
                                        <!-- comment item depth 1 -->
                                        <?php $__currentLoopData = $item->userNotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/farsgam1/domains/farsgamer.com/farsgamer/resources/views/site/dashboard/my-orders-component.blade.php ENDPATH**/ ?>
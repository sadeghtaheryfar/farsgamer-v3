...
<main>
    <section class="h-screen flex justify-center items-center p-6 rounded-2xl lg:p-8" style="background:#EDFDFC">
        <div class="text-center w-full">
            ...
            <h2 class="text-lg font-medium sm:text-xl">شما اجازه انجام این کار را ندارید</h2>
            <img class="max-w-sm mx-auto mt-8 sm:w-1/2" src="<?php echo e(asset('site/svg/403.svg')); ?>" alt="404">
...
<?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/errors/403.blade.php ENDPATH**/ ?>
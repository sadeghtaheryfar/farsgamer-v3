...
} elseif ($_instance->childHasBeenRendered('l3351719861-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3351719861-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3351719861-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3351719861-0');
} else {
    $response = \Livewire\Livewire::mount('site.dashboard.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3351719861-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                        ...
                        <div class="flex-box flex-justify-space flex-aling-auto width-max-mobile">
                            <div class="box-detalist-last-order-dashboard flex-box flex-right">
                                <div class="box-time-order-dashboard flex-box flex-column">
                                    <span><?php echo e(jalaliDate($item->created_at, '%d')); ?></span>

                                    <span><?php echo e(jalaliDate($item->created_at, '%B')); ?></span>
                                </div>
                            ...
                            <div class="box-message-order-dashboard flex-box width-max-mobile">
                                <span><?php echo e($item->meta['description']); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="flex-box width-max-mobile flex-left">
                            <?php if($item->type == 'deposit'): ?>
                                <div class="box-price-order-dashboard">
                                    <span dir="ltr">+<?php echo e(number_format($item->amount)); ?></span>
...
<?php /**PATH C:\Users\Asian\Documents\GitHub\farsgamer-v3\resources\views/site/dashboard/dashboard-component.blade.php ENDPATH**/ ?>
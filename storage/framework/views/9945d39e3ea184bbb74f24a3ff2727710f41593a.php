<?php if(count($giftCards) > 0): ?>
    <section class="mt-10 bg-white rounded-2xl pt-6 px-10 pb-10">
        <div class="flex items-center justify-between mb-4 lg:mb-6">
            ...
            <a class="flex gap-2 items-center" href="<?php echo e(route('products')); ?>?category=giftcard&sort=available">
...
<?php endif; ?><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/homes/gift-cards.blade.php ENDPATH**/ ?>
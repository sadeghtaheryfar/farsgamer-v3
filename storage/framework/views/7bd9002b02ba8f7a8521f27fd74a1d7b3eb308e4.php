<div class="grid gap-4 xl:grid-cols-12 xl:items-start xl:gap-8 p-4">
                ...
                <table>
                    ...
                    <?php $__currentLoopData = $data->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<tr class="order-details__item border-0">
							...
							<td class="bg-gray-50">
                                <div class="flex items-center gap-1 whitespace-nowrap">
                                    <p class="text-lg font-semibold"><?php echo e(number_format($item['partner_price'])); ?></p>
                        ...
                        <tr class="order-details__item border-0">
                            ...
                            <td class="bg-gray-50">
                                <div class="flex items-center gap-1 whitespace-nowrap">
                                    <p class="text-lg font-semibold"><?php echo e(number_format($item->product->partner_price)); ?></p>
                                    <p class="text-sm">تومان</p>
                                </div>
                            </td>
    ...
    <div class="xl:col-start-9 xl:col-end-13 2xl:col-start-10 xl:row-span-full">
        <a class="p-4 lg:p-6 bg-white rounded-2xl flex items-center justify-center gap-2 mb-4 link-transition hover:text-primary-deep"
           href="<?php echo e(route('partner.order',['action'=>'edit', 'id' => $data->id])); ?>">
...
<?php $__env->stopPush(); ?><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/partner/carts/cart-checkout-component.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('ywWkMdP')) {
    $componentId = $_instance->getRenderedChildComponentId('ywWkMdP');
    $componentTag = $_instance->getRenderedChildComponentTagName('ywWkMdP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ywWkMdP');
} else {
    $response = \Livewire\Livewire::mount('site.dashboard.sidebar', []);
    $html = $response->html();
    $_instance->logRenderedChild('ywWkMdP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/site/dashboard/dashboard-component.blade.php ENDPATH**/ ?>
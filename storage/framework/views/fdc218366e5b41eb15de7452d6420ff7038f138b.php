        ...
        <div>
            ...
            <div class="window-tabs">
                <div class="tab-control" wire:ignore>
                    <ul>
                        <?php if(!empty($windows->id)): ?>
                            <li data-id="window" class="<?php echo e(!empty($active_slide) ? 'active' : ''); ?>">ویترین
                            </li>
                        <?php endif; ?>
                        <li data-id="skin"
                            class="<?php echo e(empty($windows->id) ? 'active' : ''); ?> <?php echo e(!empty($active_slide2) ? 'active' : ''); ?>">
                            محصولات</li>
                        <li></li>
                    </ul>
                </div>
                <div class="tabs">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 p-0">
                                        <div class="window-product-dtails">
                                            ...
                                            <div class="col-12">
                                                <a href="<?php echo e(route('products.show', ['slug' => $mainProduct->slug])); ?>"
                    ...
                    <?php endif; ?>
                    <div class="slide skin <?php echo e(empty($windows->id) ? 'active_slide' : ''); ?> <?php echo e($active_slide2); ?>"
                                        ...
                                        <div class="filters mt-1">
                                            <div class=" form-switch d-flex align-items-center py-2 px-1">
                                                <div class="product-checkbox d-flex align-items-center">
                                                    ...
                                                    <input type="checkbox" <?php echo e($level == 1 ? 'checked' : ''); ?>
                                                            ...
                                                            <div class="price-range desk p-0" wire:ignore.self>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <input value="0" disabled type="text"
                                                                        class="p-1">
                                                                    <small>تا</small>
                                                                    <input value="<?php echo e(number_format($range)); ?>" disabled
                                                                        class="p-1" type="text">
                                                                    <small>تومان</small>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="d-flex align-items-center py-1">
                                                                    <input class="form-check-input"
                                                                        ...
                                                                        id="sub_category<?php echo e($item['id']); ?>d"
                                                                        wire:model="sub_category">
                                                                    <label class="mb-0 mx-2 form-check-label"
                                                                        for="sub_category<?php echo e($item['id']); ?>d"><?php echo e($item['title']); ?></label>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <?php $__currentLoopData = $item['filters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="d-flex align-items-center py-1">
                                                                    <input type="checkbox"
                                                                        ...
                                                                        id="fliter<?php echo e($filter['id']); ?>d"
                                                                        wire:model="filter.<?php echo e($filter['id']); ?>">
                                                                    <label class="mb-0 mx-2 form-check-label"
                                                                        for="fliter<?php echo e($filter['id']); ?>d"><?php echo e($filter['title']); ?></label>
                                                                </div>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="d-flex align-items-center py-1">
                                                                    <div class="price-range res p-0">
                                                                        ...
                                                                        <div class="text-center">
                                                                            ...
                                                                            <small>تا</small>
                                                                            <input value="<?php echo e(number_format($range)); ?>"
                                                                    ...
                                                                    <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <div class="d-flex align-items-center py-1">
                                                                            <input class="form-check-input"
                                                                                value="<?php echo e($item['id']); ?>"
                                                                                name="sub_categorym" type="radio"
                                                                                id="sub_category<?php echo e($item['id']); ?>m"
                                                                                wire:model="sub_category">
                                                                            <label class="mb-0 mx-2 form-check-label"
                                                                                for="sub_category<?php echo e($item['id']); ?>m"><?php echo e($item['title']); ?></label>
                                                                        </div>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="dropdown-container mt-2">
                                                                    <?php $__currentLoopData = $item['filters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <div class="d-flex align-items-center py-1">
                                                                            <input type="checkbox"
                                                                                class="big-checkbox form-check-input"
                                                                                id="fliter<?php echo e($filter['id']); ?>m"
                                                                                wire:model="filter.<?php echo e($filter['id']); ?>">
                                                                            <label class="mb-0 mx-2 form-check-label"
                                                                                for="fliter<?php echo e($filter['id']); ?>m"><?php echo e($filter['title']); ?></label>
                                                                        </div>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </div>
                                                            </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Asian\Documents\GitHub\farsgamer-v3\resources\views/site/categories/category-component.blade.php ENDPATH**/ ?>
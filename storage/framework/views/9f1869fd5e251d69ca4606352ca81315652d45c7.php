...
<?php $component->withAttributes(['title' => 'نظر','mode' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($mode)]); ?>
                <div class="col-12 mb-1">
                    <?php if(($this->model->commentable_type ?? '') == 'article'): ?>
                        <span>مقاله : </span>
                        <a href="<?php echo e(route('admin.articles.store',
                        ['action'=>'edit', 'id' => $this->model->commentable->id])); ?>"><?php echo e($this->model->commentable->title); ?></a>
                    <?php else: ?>
                        <span>محصول : </span>
                        <a href="<?php echo e(route('admin.products.store',
                        ['action'=>'edit', 'id' => $this->model->commentable->id])); ?>"><?php echo e($this->model->commentable->title); ?></a>
                    <?php endif; ?>
                </div>

                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin.forms.textarea','data' => ['id' => 'comment','label' => 'نظر','required' => 'true','rows' => '5','wire:model.defer' => 'comment']]); ?>
<?php $component->withName('admin.forms.textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'comment','label' => 'نظر','required' => 'true','rows' => '5','wire:model.defer' => 'comment']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.admin.forms.textarea','data' => ['id' => 'answer','label' => 'پاسخ','required' => 'true','rows' => '5','wire:model.defer' => 'answer']]); ?>
<?php $component->withName('admin.forms.textarea'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['id' => 'answer','label' => 'پاسخ','required' => 'true','rows' => '5','wire:model.defer' => 'answer']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
...
</div><?php /**PATH /home/fortnit2/domains/farsgamer.com/farsgamer/resources/views/admin/comments/store-comment.blade.php ENDPATH**/ ?>
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function add($product, $quantity, $form)
        {
                        /** @var \App\Http\Controllers\Cart\Cart $instance */
                        return $instance->add($product, $quantity, $form);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Http\Controllers\Cart\Cart $instance */
                        return $instance->update($id, $quantity);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function total($walletAmount = 0)
        {
                        /** @var \App\Http\Controllers\Cart\Cart $instance */
                        return $instance->total($walletAmount);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function sendVerification($number, $code)
        {
                        /** @var \App\Http\Controllers\Smsir\Smsir $instance */
                        return $instance->sendVerification($number, $code);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Http\Controllers\Smsir\Smsir $instance */
                        return $instance->send($messages, $numbers, $sendDateTime);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Http\Controllers\Smsir\Smsir $instance */
                        return $instance->ultraFastSend($parameters, $template_id, $number);
        }
...
namespace  { 
            ...
            class Cart extends \App\Http\Controllers\Cart\Facades\Cart {}
            class Smsir extends \App\Http\Controllers\Smsir\Facades\Smsir {}
